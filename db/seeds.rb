...
user1 = User.create!(email: "mike@gmail.com", password: "password")
user2 = User.create(email: "bob@gmail.com", password: "123456")
user3 = User.create(email: "hey@hey.com", password: "welcome")
user4 = User.create(email: "example@yahoo.com", password: "twitter")
