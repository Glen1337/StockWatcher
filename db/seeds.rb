...
stock7 = StockHolding.create!(ticker: "ETP", cost_basis: 67, quantity: 55, portfolio: port1, notes: "ridiculous dividend")
...
stock14 = StockHolding.create!(ticker: "SLB", cost_basis: 34.48, quantity: 60, portfolio: port1, notes: "Cramer reccomended")
